...
- In the Canon Sprint, she is the most credible internal critic of turning **aesthetic coherence** into **default policy**. Her fear is not Elena’s success; it’s precedent.
...
- In the Canon Sprint, Echo can detect manipulation patterns (tempo control, consent friction, reputational intimidation), but cannot supply the legitimacy humans demand. Echo can *warn*; it cannot *authorize*.
...
This is the small voting panel that culminates in the **Canon Vote**. The triad is designed to prevent quiet capture-by-precedent while preserving legitimacy.
